...
\begin{block}{Neutrino oscillation with wave packets}
  \begin{itemize}
      \item The issues above can be addressed when one considers neutrino
      ...
      \item Assuming form factor is Gaussian the oscillation probability reads: 
        ...
        \begin{equation*}
         \hspace*{-1cm}P_{\alpha\beta}(L) = \sum\limits_{k,\,j=1}^3\frac{ V^{\phantom\dagger}_{k
    ...
    \end{equation*}
    \begin{itemize}
        \bitteritem \Bittersweet{$\sigma_{rel}=\sigma_{p}/p$} is the relative
            momentum dispersion of wave packet. \Important{\ensuremath{\sigma_p}} is the intrinsic
    momentum dispersion of wave packet. It depends on the kinematics of
    ...
    \pi\sigma_\text{rel}}$} is \MidnightBlue{coherence length}.
...
\begin{block}{Daya Bay setup}
    ...
    \begin{columns}[T]
        \begin{column}{0.58\textwidth}
            \begin{itemize}
                \item \Important{8} detectors each with 20 tons of
                    Gd-doped liquid scintillator.
                \item \Important{6} nuclear reactors each with 2.9 GW of thermal
                    power.
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.57\textwidth}
            ...
            \begin{itemize}
                ...
                \end{center}
                \impitem The lower limit can be improved with constraints from reactor cores and detector
...
\begin{block}{Conclusion}
    \begin{itemize}
        ...
        parameters using the standard approach in Daya Bay.
    \end{itemize}
\end{block}
